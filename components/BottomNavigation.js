...
const BottomNavigation = ({ activeTab = 'home' }) => {
  ...
  useEffect(() => {
    if (pathname.includes('/HomeScreen')) {
      setCurrentTab('home');
    } else if (pathname.includes('/NutrientsScreen')) {
      setCurrentTab('nutrients');
    } else if (pathname.includes('/ScanProductScreen')) {
      setCurrentTab('scan');
    } else if (pathname.includes('/AnalysisHistoryScreen')) {
      setCurrentTab('history');
    } else if (pathname.includes('/ProfileScreen')) {
