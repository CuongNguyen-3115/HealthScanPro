    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll} bounces={false}>
        <View style={styles.topSection}>
          ...
          <Text style={styles.subtitle}>Phân tích thông minh sản phẩm cho sức khỏe của bạn</Text>
        </View>
        ...
        <View style={styles.bottomSection}>
          <View style={styles.card}>
            ...
            <Text style={styles.cardDescription}>
              Cá nhân hóa đánh giá dựa trên tình trạng sức khỏe của bạn. Phù hợp cho người tiểu đường, dị ứng, thừa cân...
            </Text>
            <TouchableOpacity
              style={styles.buttonGreen}
              onPress={() => router.push('HealthFormScreen')} // ✅ dùng tên file màn hình
            >
          ...
          <View style={styles.card}>
            ...
            <TouchableOpacity 
              ...
              onPress={() => router.push('ScanProductScreen')} // ✅ dùng tên file màn hình
              >
...
const styles = StyleSheet.create({
  ...
  scroll: { minHeight: height, justifyContent: 'flex-start' },
  topSection: {
  ...
  subtitle: { fontSize: 12, color: 'black', textAlign: 'center', marginTop: 4 },
  bottomSection: {
    padding: 20,
    alignItems: 'center',
  ...
  cardDescription: { fontSize: 12, color: 'black', marginBottom: 16 },
  buttonGreen: {
    flexDirection: 'row',
